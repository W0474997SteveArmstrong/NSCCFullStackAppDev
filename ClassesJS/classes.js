...
const programmer = new Programmer("Stevie",2,"A",'javascript','steve.github.io')
console.log(emp1);
console.log(emp1.joiningYear());
//Static methods are accessed using class names
console.log(Employee.add(3,5));
console.log(programmer.givenDivision);
console.log(Programmer.multiply(4,5));
console.log(programmer.favouriteProgrammingLanguage());