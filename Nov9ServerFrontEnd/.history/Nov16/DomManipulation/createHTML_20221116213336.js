...
//It won't work.So store the different parts as a variable and use the variables.
...
//innerHTML has some security concerns so there is an alternate way to do it
