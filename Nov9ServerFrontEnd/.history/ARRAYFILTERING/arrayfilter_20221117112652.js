...
const people =[{name:"Dean",age:51},{name:"Fluer",age:28},{name:"Bart",age:21},{name:"Chimichangas",age:102}];

const peopleOver50 = people.filter(x=>x.age>50);
console.log(peopleOver50);


const peopleUnder100with_e_inName = people.filter(x=>x.age<100 && x.name.includes('e'));
