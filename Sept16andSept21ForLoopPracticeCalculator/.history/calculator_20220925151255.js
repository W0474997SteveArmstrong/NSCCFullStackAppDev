...
let question = rls.qu'("If you want to exit calculation, type Y else type N");
function appExitOrRun(){
if (question==Y){
    arithmeticOperations();
}
else if(question==N){
    ...
    let invInput = rls.question("Invalid Input please key in option either Y or N");
    question=invInput;
}
}
