...
// `
// )
const chosenOperation = Number(rls.question('Please choose the math operation you want to perform by entering the number associated with the operation from the options below: '));
let firstNum =null;
