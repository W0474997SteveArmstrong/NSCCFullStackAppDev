...
fetch(`https://restcountries.com/v2/all`)
    ...
    function getPopulation(json){
        ...
        .filter(countries=>countries.languages.filter((language)=>language.name=="English")) //grab only those China bordering countries where language is 
        //a property and only select those countries which have English as the official language
        .reduce((populationCount,countries)=>(populationCount+=countries.population),0); //get the count of their population
