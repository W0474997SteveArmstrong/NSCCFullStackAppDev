...
function loopingLineByLineChoices(lineArrChoice) {
    for (const rowChoice of lineArrChoice) {
        ...
        innerRowChoiceArray.push(rowChoice.split(DELIMITER));
        console.log("The InnerRowArray is: ", innerRowChoiceArray);
...
loopingLineByLineStory(fileReadChoices("files/the_choices_file.csv", "utf-8"));
