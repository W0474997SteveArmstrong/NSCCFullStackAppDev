...
function loopingLineByLine(lineArr) {
  for (const row of lineArr) {
    ...
    //   ]
      ...
      for (let rowChoicesFile of fileRead("files/the_choices_file.csv", "utf-8")) {
        console.log("RowStoryFile before change is :", rowChoicesFile);
        // The itsy bitsy _1_ _2_ up the _3_ spout.
        let wordRow = rowChoicesFile.split(" ");
        ...
        userInputPerQuestionDict = {
          ...
          console.log("Dictionary in "+counter+"iteration is: ",userInputPerQuestionDict);
          //inner for loop exit
        ...
        if (userInputArrTotal.includes(A)) {
          console.log(
            "replacement is: ",
            rowChoicesFile.replace(wordRow[3], userInputPerQuestionDict.A)
          );
           //   replacement is:  The itsy bitsy aardvark _2_ up the _3_ spout.
           rowChoicesFile = rowChoicesFile.replace(wordRow[3],userInputPerQuestionDict.A);
        
        }
        else if(userInputArrTotal.includes(B)){
            console.log(
                "replacement is: ",
                rowChoicesFile.replace(wordRow[3], userInputPerQuestionDict.B)
              );
              rowChoicesFile = rowChoicesFile.replace(wordRow[3],userInputPerQuestionDict.B);
          }
          else if(userInputArrTotal.includes(C)){
            console.log(
                "replacement is: ",
                rowChoicesFile.replace(wordRow[3], userInputPerQuestionDict.C)
              );
              rowChoicesFile = rowChoicesFile.replace(wordRow[3],userInputPerQuestionDict.C);
          }
          else if(userInputArrTotal.includes(D)){
            console.log(
                "replacement is: ",
                rowChoicesFile.replace(wordRow[3], userInputPerQuestionDict.D)
              );
              rowChoicesFile = rowChoicesFile.replace(wordRow[3],userInputPerQuestionDict.D);
          }
          else if(userInputArrTotal.includes(E)){
            console.log(
                "replacement is: ",
                rowChoicesFile.replace(wordRow[3], userInputPerQuestionDict.E)
              );
              rowChoicesFile = rowChoicesFile.replace(wordRow[3],userInputPerQuestionDict.E);
          }
          break;
          case 1:
            if (userInputArrTotal.includes(A)) {
                console.log(
                  "replacement is: ",
                  rowChoicesFile.replace(wordRow[4], userInputPerQuestionDict.A)
                );
                 //   replacement is:  The itsy bitsy aardvark _2_ up the _3_ spout.
                 rowChoicesFile = rowChoicesFile.replace(wordRow[4],userInputPerQuestionDict.A);
              
              }
              else if(userInputArrTotal.includes(B)){
                  console.log(
                      "replacement is: ",
                      rowChoicesFile.replace(wordRow[4], userInputPerQuestionDict.B)
                    );
                    rowChoicesFile = rowChoicesFile.replace(wordRow[4],userInputPerQuestionDict.B);
                }
                else if(userInputArrTotal.includes(C)){
                  console.log(
                      "replacement is: ",
                      rowChoicesFile.replace(wordRow[4], userInputPerQuestionDict.C)
                    );
                    rowChoicesFile = rowChoicesFile.replace(wordRow[4],userInputPerQuestionDict.C);
                }
                else if(userInputArrTotal.includes(D)){
                  console.log(
                      "replacement is: ",
                      rowChoicesFile.replace(wordRow[4], userInputPerQuestionDict.D)
                    );
                    rowChoicesFile = rowChoicesFile.replace(wordRow[4],userInputPerQuestionDict.D);
                }
                else if(userInputArrTotal.includes(E)){
                  console.log(
                      "replacement is: ",
                      rowChoicesFile.replace(wordRow[4], userInputPerQuestionDict.E)
                    );
                    rowChoicesFile = rowChoicesFile.replace(wordRow[4],userInputPerQuestionDict.E);
                }
                break;
          counter++;
        }
        ...
        console.log("RowStoryFile Final is: ",rowSrowChoicesFiletoryFile);
      }
