      ...
      userInputArrTotal.push(userInput);
        for(let rowStoryFile of fileRead("files/the_story_file.txt", "utf-8")){
            ...
            if(userInputArrTotal.includes(A)){
              console.log("replacement is: ",rowStoryFile.replace(wordRow[3],userInputPerQuestionDict.A));
            rowStoryFile= rowStoryFile.replace(wordRow[3],
        userInputPerQuestionDict.A);
        let updatedRowStoryFile = rowStoryFile.replace(wordRow[4])

        console.log("UpdatedRowStoryFile",updatedRowStoryFile);
            ...
            console.log("WordRow value at fourth index is:",wordRow[3]);
