...
for (const row of lineArr) {
  ...
  //We will have each word of a single line as an item in the Array and
  //at the end of in each iteration so we empty the 
  //array items at the end of each iteration.
  innerRowArray.pop();
