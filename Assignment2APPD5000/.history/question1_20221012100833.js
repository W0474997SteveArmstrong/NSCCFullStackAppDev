...
split(/\r?\n/).forEach(function(line){
    if(20<line.length){
        ...
        console.log(modifiedLowercaseLine);
        let lineArr = modifiedLowercaseLine.split();
        totalLineArr.push(lineArr);
    }
    else{
        let uppercaseLine = line.toUpperCase();
        console.log(counter++ +":"+" "+uppercaseLine);
    }
    // console.log("Logging the line:"+line);

});
console.log("TotalLineArr is: ",totalLineArr);
