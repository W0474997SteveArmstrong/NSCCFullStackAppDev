...
for(let currentTurn=1;currentTurn<MAX_TURNS;currentTurn++){
   ...
   console.log("indicesArr at the start of each iteration",indicesArr);
    let userInputArrInsideAttackShip = attackShip(indicesArr,userInputArr,hitsCountMap,numHits);
...
function attackShip(indicesArr,userInputArr,hitsCountMap,numberOfHits){
    ...
    if("1"===innerArrOfFileContentArr[indicesArr[0][0]][indicesArr[0][1]]){
        ...
        numberOfHits++;
        console.log("numHits inside attackShip is:",numberOfHits);
    }
