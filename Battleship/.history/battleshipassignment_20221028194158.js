...
//Challenge is to make the index of userArray and innerArrOfFileContentArr
...
function attackShip(indicesArr){
    console.log("FileContentArr within attackShip is:",fileContentArr);
    console.log("The ships value within attack ship:", fileContentArr[indicesArr[0][0]][indicesArr[0][1]]);
