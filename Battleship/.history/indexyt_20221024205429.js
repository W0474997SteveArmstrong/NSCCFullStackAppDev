...
while(null==x){
  let x = RLS.question("Enter the x- co-ordinate for your ship number " + index +": ");
    if(x>myGridsize){
        x = RLS.question("Please enter a valid co-ordinate which must be less than your chosen grid size of: "+myGridsize
        );
    }
}
while(null==y){
  let y = RLS.question("Enter the y- co-ordinate for your ship number " + index +": ");
  if(y>myGridsize){
    y = RLS.question("Please enter a valid co-ordinate which must be less than your chosen grid size of: "+myGridsize
    );
}
}
