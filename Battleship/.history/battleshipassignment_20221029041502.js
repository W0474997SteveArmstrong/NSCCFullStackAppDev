      ...
      if (0 == missileCounter) {
        ...
        console.log(
          "You had " +
            ...
            " of " +
            NUMBER_OF_SHIPS +
            " hits, but didn't sink all the ships."
        );
...
function attackShip(indicesArr, userInputArr, hitsCountMap, numHits) {
  ...
  if ("1" === innerArrOfFileContentArr[indicesArr[0][0]][indicesArr[0][1]]) {
    ...
    "0" === innerArrOfFileContentArr[indicesArr[0][0]][indicesArr[0][1]]
  ) {
    console.log("Miss");
