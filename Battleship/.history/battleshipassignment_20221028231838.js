...
for(let currentTurn=1;currentTurn<MAX_TURNS;currentTurn++){
   ...
   console.log("indicesArr at the start of each iteration",indicesArr);
    let userInputArrInsideAttackShip = attackShip(indicesArr,userInputArr,numHits);
...
//Split based on first character of string
...
function getUserInput(){
    ...
    let usrCoordinateArr = usrCoordinates.split("");
        ...
        usrCoordinateRowIndex = parseInt(usrCoordinateArr[1])-1;
            ...
            usrCoordinateArr=[];
            usrCoordinateAlphabetStr=usrCoordinates.substring(0,1);
            usrCoordinateNumberStr =usrCoordinates.substring(1);
            console.log("usrCoordinateAlphabetStr",usrCoordinateAlphabetStr);
            console.log("usrCoordinateAlphabetStr",usrCoordinateNumberStr);
...
function attackShip(indicesArr,userInputArr,numHits){
