...
while(null==myGridsize || myGridsize==0){
    myGridsize = RLS.question("What size do you like your grid to be?");
}
while(null==opponentGridsize || opponentGridsize)
    opponentGridsize=RLS.question("What size would you like your enemy grid to be?");
}
